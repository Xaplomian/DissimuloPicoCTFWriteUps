#This was slightly changed after the end of the competition, because it did not work; there was a typo in getting the binary length. Commented out lines were for testing and debugging.
